...
const Registration = () => {
  ...
  return (
    <div style={{ backgroundImage: `url(${kuva})`, backgroundRepeat: 'no-repeat',  maxHeight: screenHeight,  minHeight: screenHeight , height: '99vh', backgroundSize: '100% 100%',  width: '99vw' }}>
