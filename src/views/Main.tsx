...
const Main = () => {
  ...
  return (
    <div style={{ backgroundImage: `url(${kuva})`, backgroundRepeat: 'no-repeat',maxHeight: screenHeight , height: screenHeight, backgroundSize: '100% 100%',  width: screenWidth, objectFit: 'fill'}}>
