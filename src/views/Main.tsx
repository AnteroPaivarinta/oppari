...
const Main = () => {
  ...
  return (
    <div style={{ backgroundImage: `url(${kuva})`, backgroundRepeat: 'no-repeat',maxHeight: screenHeight , height: screenHeight, backgroundSize: 'cover',  width: screenWidth, objectFit: 'fill'}}>
